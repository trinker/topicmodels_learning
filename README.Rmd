...
- Blei, D. (n.d.). [David Blei on Topic Models](https://www.cs.princeton.edu/~blei/topicmodeling.html)
...
- Chang J. (2010). lda: Collapsed Gibbs Sampling Methods for Topic Models. R package version 1.2.3, http://CRAN.R-project.org/package=lda.

- Gr&uuml;en, B. & Hornik, K. (2011). [topicmodels: An R Package for Fitting Topic Models. Journal of Statistical Software](/articles/Gruen2011.pdf), 40(13), 1-30. 

- Mimno, D. (2013). mallet: A wrapper around the Java machine learning tool MALLET. https://CRAN.R-project.org/package=mallet
